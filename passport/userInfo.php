...
analyser_insert_view(Analyser::M_ARTICLE, 'userInfoId');
...
if (true) {
    ...
    $tplCenter->setActionFiles(array(
        'Display' => 'userInfo.Display.tpl.html'
        , 'Add' => 'userInfo.Edit.tpl.html'
        , 'Edit' => 'userInfo.Edit.tpl.html'
        , 'List' => 'userInfo.List.tpl.html'
        , 'Modify' => 'userInfo.List.tpl.html'
        , 'Noti' => 'userInfo.Notifaction.tpl.html'
    ));
    ...
    if ($isFrontend) {
        /* @var $tplInfo TplInfo */
        $tplInfo = $tplCenter->getInfo(UserInfo::modSn, $tplSn);
...
if (!$isCached) {
    ...
    require_once 'lang/UserInfo/zh-cn/UserInfo.Lang.php';
